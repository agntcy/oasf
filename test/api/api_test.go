...
var _ = Describe("API", func() {
	...
	Describe("Classes API - id and name parameter validation", func() {
		classEndpoints := []struct {
			...
			{"skills", "/api/skills", "contextual_comprehension", "10101", "10102", "natural_language_processing/natural_language_understanding/contextual_comprehension"},
			{"domains", "/api/domains", "internet_of_things", "101", "902", "technology/internet_of_things"},
			{"modules", "/api/modules", "prompt", "304", "303", "runtime/prompt"},
		}
	...
	Describe("Categories API - id and name parameter validation", func() {
		categoryEndpoints := []struct {
			...
			{"module_categories", "/api/module_categories", "runtime", "3", "1", "runtime/prompt", "prompt"},
			{"skill_categories", "/api/skill_categories", "natural_language_processing", "1", "5", "natural_language_processing/personalization", "personalization"},
			{"domain_categories", "/api/domain_categories", "healthcare", "9", "1", "healthcare/telemedicine", "telemedicine"},
		}
